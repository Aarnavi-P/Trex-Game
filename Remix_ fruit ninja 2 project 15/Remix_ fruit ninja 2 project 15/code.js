...
textFont("Georgia");
var score=0;
var sword=createSprite(40,200,20,20);
...
function draw() {
  ...
  if(gamestate===END){
    ...
    sword.setAnimation("textGameOver");
    sword.x=200;
    sword.y=200;
  }
 drawSprites();
